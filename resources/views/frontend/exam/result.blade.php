    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">{{ trans('navs.frontend.result.result-overview')}}</div>
                    ...
                    @if(isset($wrong_answer) || isset($correct_answer))
                       ...
                       @if(isset($wrong_answer))
                            ...
                            @foreach($wrong_answer as $key => $value )
                                <li class="list-group-item">Question: <b>{{ \App::make('App\Http\Controllers\Frontend\Question\QuestionController')->getQuestion($key) }}</b>
                                
                                <?php $options =  \App::make('App\Http\Controllers\Frontend\Question\QuestionController')->getOptions($key);?>
                                 <?php $wrong_single_answers = \App::make('App\Http\Controllers\Frontend\Question\QuestionController')->getSingleCorrectAnswer($key);?>
                                @foreach($options as $option)
                                    ...
                                    <dd class="text-success">{{ \App::make('App\Http\Controllers\Frontend\Question\QuestionController')->getAnswer($wrong_single_answers[0]->option_id)->option }}</dd>
                                    @else
                                        @foreach($wrong_single_answers as $answers)
                                            <dd class="text-success">{{ \App::make('App\Http\Controllers\Frontend\Question\QuestionController')->getAnswer($answers->option_id)->option }}</dd>
                                        @endforeach
                                    @endif
                                    </dl>
                                </li> 
